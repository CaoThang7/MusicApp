...
public class DBhelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(sql);
        sql="INSERT INTO MUSIC(ChudeMusic,tenMusic,tacgia,giasanpham,file,soluong) VALUES('Nhac K_POP','lac troi oc cko','Son tung mtp',400,'teaser2','false')";
        db.execSQL(sql);
        sql="INSERT INTO MUSIC(ChudeMusic,tenMusic,tacgia,giasanpham,file,soluong) VALUES('Nhac V_POP','Lac troi','Son tung mtp',400,'vn147','false')";
        db.execSQL(sql);
        sql="INSERT INTO MUSIC(ChudeMusic,tenMusic,tacgia,giasanpham,file,soluong) VALUES('Nhac V_POP','Tuy am','Masew',300,'tuyam','false')";
        db.execSQL(sql);
        sql="INSERT INTO MUSIC(ChudeMusic,tenMusic,tacgia,giasanpham,file,soluong) VALUES('Nhac V_POP','Yeu 5','Rhymastic',500,'yeu5','false')";
        db.execSQL(sql);
        sql="INSERT INTO MUSIC(ChudeMusic,tenMusic,tacgia,giasanpham,file,soluong) VALUES('Nhac V_POP','Kem Duyen','Rum & Masew',450,'kemduyen','true')";
        db.execSQL(sql);
